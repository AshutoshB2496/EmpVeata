...
export class MyTasksComponent implements OnInit {
    ...
    addTask() {
        ...
        this.service.AddTask(this.tasks.value, this.day).subscribe(res => {
            this.refreshOpen();
            this.refreshDue();
            this.tasks = this.fb.group({
                task: [null, [Validators.required]],
    ...
    refreshOpen() {
        this.service.getOpenTasks().subscribe(value => {
            this.tasks_open = value;
        });
    }

    refreshMarked() {
        this.service.getMarkedTasks().subscribe(value => {
            this.tasks_marked_done = value;
        });
    }

    refreshCompleted() {
        this.service.getCompletedTasks().subscribe(value => {
            this.tasks_completed = value;
        });
    }

    refreshDue() {
        this.service.getdueTodayTasks().subscribe(value => {
